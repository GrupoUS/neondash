...
/**
 * @author: @dorianbaffier (adapted for React/Vite)
 * @description: Smooth Drawer - Animated drawer component with Framer Motion
 * @version: 1.1.0
 * @license: MIT
...
interface SmoothDrawerProps extends React.HTMLAttributes<HTMLDivElement> {
  ...
  /** Primary action href (if provided, renders as link) */
  primaryHref?: string;
}
...
export function SmoothDrawer({
  title = "Premium Plan",
  description = "Access all features with a one-time payment. No subscriptions, no hidden fees.",
