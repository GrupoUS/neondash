    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className={cn(
            "fixed inset-y-0 right-0 z-50 w-full sm:w-[400px] bg-background border-l shadow-2xl flex flex-col",
            className
          )}
        >
          {/* Header */}
                    ...
                    <CardContent className="space-y-3">
                      ...
                      <div className="space-y-1">
                        ...
                        <div className="text-xs p-2 bg-muted/50 rounded-md text-muted-foreground">
                          Cliente incomodada com "bigode chinês" e flacidez leve. Já fez botox há 6
                          meses.
                        </div>
                      </div>
                    </CardContent>
